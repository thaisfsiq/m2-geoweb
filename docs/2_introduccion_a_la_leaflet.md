...
###  ¿Cómo empezar?
Descargar[datos/web.zip">web.zip) y descomprimir dentro de
nuestro directorio del servidor web
  Abrimos nuestro editor de text i creamos la página
  **Ejemplo0.html** dentro directorio web
 ...
 *  Usamos **L.tileLayer()** para crear una capa base en un servidor OSM de tiles. {z}/{x}/{y}. También pasamos algunas
opciones Attribution : atribución de la capa maxZoom y minZoom :niveles de zoom.
...
!!! note
    **Ejercicio **: Creamos un nuevo ejemplo con tres capas de fondo:Mapa,Orto,Híbrido
